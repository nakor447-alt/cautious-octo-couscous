...
public class TriangleAreaTestNG {
    ...
    public void testAreaByBaseAndHeight() {
        Assert.assertEquals(TriangleArea.calculateByBaseAndHeight(5.0, 4.0), 10.0, 0.001);
    }
    ...
    public void testHeronFormula() {
        Assert.assertEquals(TriangleArea.calculateByHeron(3, 4, 5), 6.0, 0.001);
    }
    ...
    public void testAreaByLegs(double leg1, double leg2, double expected) {
        Assert.assertEquals(TriangleArea.calculateByLegs(leg1, leg2), expected, 0.001);
    }
}